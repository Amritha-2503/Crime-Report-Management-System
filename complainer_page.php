  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="complainer_page.php">File a New Complaint</a></li>
...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
		 <div class="bg-agile">
			<br><br>
			<div class="login-form" style="background-size=auto;"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
        <p><h2>File a New Complaint</h2></p>
                                    <a href="record_complaint.php" class="btn btn-default btn-lg centered-button" role="button" style="width: 290px;" aria-pressed="true">Record Complaint</a>
                                    <br><br>	
				<form action="#" method="post" style="color: gray">Aadhar Number
				...
				<div class="top-w3-agile" style="color: gray">Type of Crime
					...
					<div class="top-w3-agile" style="color: gray">
					Description
						<textarea  name="description" rows="20" cols="50" placeholder="Describe the incident in details with time" onfocusout="f1()" id="desc" required><?php echo "$desc"; ?></textarea>
					</div>
